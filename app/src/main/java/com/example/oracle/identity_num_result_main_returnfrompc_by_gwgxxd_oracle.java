 ...
 */
public class identity_num_result_main_returnfrompc_by_gwgxxd_oracle {



    public static List<String> List_result;

    public static void get_identity_num_result_main_returnfrompc_by_gwgxxd_oracle(String flag, String updatetime, String user, String xianlu, String chehao, String chexiang, String gw, String gx, String xd) {
        try {
