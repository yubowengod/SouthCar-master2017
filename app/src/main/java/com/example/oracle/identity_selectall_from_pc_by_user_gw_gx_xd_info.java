 ...
 */
public class identity_selectall_from_pc_by_user_gw_gx_xd_info {



    public static List<String> List_result;

    public static void get_identity_selectall_from_pc_by_user_gw_gx_xd(String flag, String updatetime, String user, String xianlu, String chehao, String chexiang, String gw, String gx, String xd) {
        try {
//            public string[] select_all_from_identity_table(string user, string gw, string gx, string xd)
            ...
            Log.i("connectWebService", "22222222222222222222222222222222222222222222222222222");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static String getImageFromAndroid(String methodName, String flag, String updatetime, String user, String xianlu, String chehao, String chexiang, String gw, String gx, String xd) {
        Log.i("进入端口方法", "进入端口方法22222222222222222222222222222222222222222222");
