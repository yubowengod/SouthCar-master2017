...
public class takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ListItemAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity> items;

    public takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ListItemAdapter(Context ctx, ArrayList<takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity> items) {
        this.mContext = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity itemEntity = items.get(position);
        // 使用ImageLoader加载网络图片
