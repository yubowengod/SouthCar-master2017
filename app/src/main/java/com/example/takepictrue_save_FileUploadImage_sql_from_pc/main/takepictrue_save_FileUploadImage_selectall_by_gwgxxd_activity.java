 ...
 */
public class takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity extends AppCompatActivity{
    ...
    private Handler mainHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 2018) {
                //只要在主线程就可以处理ui
                ((ImageView) takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity.this.findViewById(msg.arg1)).setImageBitmap((Bitmap) msg.obj);
            }
        }
    };
    ...
    static ArrayList<takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity> itemEntities;
                ...
                try {
                    mainHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            itemEntities = new ArrayList<takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity>();

                            final takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity[] entity_oracle = new takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity[MainActivity_slider.xianlu_num];

                            int j=0;
                            for (int i=0;i<xianlu_oracle.getList_result().size();i=i+4)
                            {
                                entity_oracle[j] = new takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ItemEntity(
                            ...
                            listview.setAdapter(new takepictrue_save_FileUploadImage_selectall_by_gwgxxd_ListItemAdapter(takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity.this, itemEntities));
...
//                         listview 点击事件
                            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    AlertDialog.Builder ad = new AlertDialog.Builder(takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity.this);
                                    ad.setView(view);
...
//
                                    ...
                                    selfdialog.setButton("确定", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            if (chehao.equals("") || chexiang.equals("")) {
                                                ...
                                                Intent intent = new Intent(takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity.this, takepictrue_save_FileUploadImage_selectall_by_gwgxxd_deal_main_activity.class);
    ...
    private void showDialog() {
        AlertDialog dialog;
        AlertDialog.Builder builder = new AlertDialog.Builder(takepictrue_save_FileUploadImage_selectall_by_gwgxxd_activity.this);
