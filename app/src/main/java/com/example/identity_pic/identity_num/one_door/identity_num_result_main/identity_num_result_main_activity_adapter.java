 ...
 */
public class identity_num_result_main_activity_adapter extends BaseAdapter {
    /** 上下文 */
    private Context ctx;
    /** 图片Url集合 */
    ...
    public identity_num_result_main_activity_adapter(Context ctx, String [] imageUrls,String [] imageName) {
        this.ctx = ctx;
