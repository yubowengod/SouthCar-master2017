 ...
 */
public class xianlu_identity_activity extends AppCompatActivity{
    ...
    private Handler mainHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 2018) {
                //只要在主线程就可以处理ui
                ((ImageView) xianlu_identity_activity.this.findViewById(msg.arg1)).setImageBitmap((Bitmap) msg.obj);
            }
        }
    };
    ...
    static ArrayList<xianlu_identity_ItemEntity> itemEntities;
                ...
                try {
                    mainHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            itemEntities = new ArrayList<xianlu_identity_ItemEntity>();

                            final xianlu_identity_ItemEntity [] entity_oracle = new xianlu_identity_ItemEntity[MainActivity_slider.xianlu_num];

                            int j=0;
                            for (int i=0;i<xianlu_oracle.getList_result().size();i=i+4)
                            {
                                entity_oracle[j] = new xianlu_identity_ItemEntity(
                            ...
                            listview.setAdapter(new xianlu_identity_ListItemAdapter(xianlu_identity_activity.this, itemEntities));
...
//                         listview 点击事件
                            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    AlertDialog.Builder ad = new AlertDialog.Builder(xianlu_identity_activity.this);
                                    ad.setView(view);
...
//
    ...
    private void showDialog() {
        AlertDialog dialog;
        AlertDialog.Builder builder = new AlertDialog.Builder(xianlu_identity_activity.this);
