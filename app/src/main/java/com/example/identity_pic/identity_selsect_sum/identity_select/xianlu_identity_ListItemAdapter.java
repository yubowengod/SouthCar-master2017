...
public class xianlu_identity_ListItemAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<xianlu_identity_ItemEntity> items;

    public xianlu_identity_ListItemAdapter(Context ctx, ArrayList<xianlu_identity_ItemEntity> items) {
        this.mContext = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        xianlu_identity_ItemEntity itemEntity = items.get(position);
        // 使用ImageLoader加载网络图片
