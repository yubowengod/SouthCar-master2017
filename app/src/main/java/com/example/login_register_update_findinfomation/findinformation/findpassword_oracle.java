 ...
 */
public class findpassword_oracle {
    public static String List_result ;

    public static void getImageromSdk(String flag,String username,String password,String question,String answer){
        try{
            String methodName = "find_infomation";
            getImageFromAndroid(methodName,flag,username,password,question,answer);   //调用webservice
    ...
    public static String getImageFromAndroid(String methodName,String flag,String username,String password,String question,String answer){
        Log.i("进入端口方法", "进入端口方法");
