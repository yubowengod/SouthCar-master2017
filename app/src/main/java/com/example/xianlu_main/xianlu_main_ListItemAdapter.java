...
public class xianlu_main_ListItemAdapter extends BaseAdapter {

    private Context mContext;
    private ArrayList<xianlu_main_ItemEntity> items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        xianlu_main_ItemEntity itemEntity = items.get(position);
        // 使用ImageLoader加载网络图片
